...
public class ClientControllerIntegrationTest {
    ...
    //TODO: ENUM WITH ENDPOINTS?
    public static final String LOCALHOST = "http://localhost:";
    public static final String CLIENT = "/client";
    public static final String UPDATE = CLIENT + "/update";
    public static final String CLEAR_DB = CLIENT + "/clearDb";
    ...
    private ClientDTO testClient = new ClientDTO(null, "Mateusz", "Skocz");


    @BeforeEach
    public void clearDb() {
        ResponseEntity<String> responseEntity = restTemplate.getForEntity(LOCALHOST + port + CLEAR_DB, String.class);
        assertThat(responseEntity.getBody()).isEqualTo("DB cleared");

        ResponseEntity<List> responseEntity2 = restTemplate.getForEntity(LOCALHOST + port + FIND_ALL, List.class);
    ...
    public void shouldGetOneClient() {
        // Given
        ClientDTO addedClient = addClient();
